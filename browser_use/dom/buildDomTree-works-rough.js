(
    ...
    function isElementVisible(element) {
        ...
        // More restrictive visibility checks
        ...
        // For elements in iframes, check iframe visibility
        const doc = element.ownerDocument;
        if (doc !== window.document) {
            const iframe = doc.defaultView.frameElement;
            if (iframe) {
                return isElementVisible(iframe);
            }
        }
    ...
    function isTopElement(element) {
        ...
        // Elements with center outside viewport are NOT visible
